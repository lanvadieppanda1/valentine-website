...
try {
    ...
    //Recipients
    $mail->setFrom('logn145236@.com', 'Long');         //Set the sender of the message (your email address)
    $mail->addAddress('stellatran0304@gmail.com', 'Chang');     //Add a recipient (your bae's email address)
